  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    ...
    _drawControl: function(
      ...
      var size = this.cornerSize,
        ...
        cornerPadding =
          typeof this.cornerPadding === 'number' ? this.cornerPadding : 10
  ...
  fabric.util.object.extend(fabric.Canvas.prototype, {
    ...
    _removeAction: function(e, target) {
      ...
      if (this.getActiveObjects() && this.getActiveObjects() !== 'undefined') {
        this.getActiveObjects().forEachObject(function(o) {
          o.off()
          o.remove()
        })
    ...
    _rotateByDegrees: function(e, target, value) {
      var angle = parseInt(target.angle) + value,
      ...
      if (this.getActiveObjects() && this.getActiveObjects() !== 'undefined') {
        this.getActiveObjects().forEach(obj => {
          obj
            .set({
              angle: angle
            })
