<template>
  <div class="p-salesData">
    ...
    <Card class="p-salesData-top">
      <div class="p-salesData-title">
        <div class="-left">
      ...
      <Row class="p-salesData-flex" :gutter="10" style="margin-top: 20px">
    ...
    <Card class="p-salesData-top">
      <div class="p-salesData-title -three">
        <div class="-left">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      getTotalInfo() {
        this.$api.fxglDataCenter.getSalesData({
