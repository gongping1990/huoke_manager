            ...
            <div class="-p-upload">
              <Upload
                ...
                <div class="-p-upload-img"
                     :style="{backgroundImage: 'url('+addInfo.avatar+')',backgroundRepeat:'no-repeat', backgroundSize: 'cover'}">
  ...
  export default {
    ...
    methods: {
      ...
      handleSuccess(res, file) {
        if (res.code === 200) {
          this.textType = '2'
          this.addInfo.avatar = res.resultData.url
        }
      },
      handleSize() {
