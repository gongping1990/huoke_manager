  ...
  export default {
    ...
    methods: {
      ...
      getList(num) {
        ...
        this.$api.xxbTextbook.pageStepsTextBookByQuery({
      ...
      submitInfo(name) {
        ...
        this.$refs[name].validate((valid) => {
          if (valid) {
            ...
            let paramsUrl =  this.addInfo.id ? this.$api.xxbTextbook.updateStepsTextBook({
              id: this.addInfo.id,
              ...paramsData
            }) : this.$api.xxbTextbook.saveStepsTextBook(paramsData)
