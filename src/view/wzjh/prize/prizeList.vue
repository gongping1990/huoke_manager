    ...
    <Modal
      ...
      <Form ref="addInfo" :model="addInfo" :rules="ruleValidate" :label-width="100">
        ...
        <Form-item label="奖品说明" class="ivu-form-item-required">
          <editor v-model="addInfo.directions" style="width: 600px"></editor>
        </Form-item>
        <Form-item label="奖品详情" class="ivu-form-item-required">
          <editor v-model="addInfo.details" :uploadImgServer="baseUrl" style="width: 600px"></editor>
        </Form-item>
      </Form>
