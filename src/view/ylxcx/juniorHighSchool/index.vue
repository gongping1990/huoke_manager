<template>
  <div class="p-teach">
      ...
      <Row class="g-search">
        ...
        <Col :span="3" class="g-t-left">
          <div class="g-flex-a-j-center">
            ...
            <Select v-model="searchInfo.subjectEnum" @on-change="getList" class="-search-selectOne">
    ...
    <div v-if="isOpenModal">
      <add-public @closeModal="closeModal" @successEmitPublic="submitInfo" :dataProp="addInfo" :type="1"></add-public>
    </div>
  </div>
</template>
      ...
      return {
        ...
        columns: [
          ...
          },
          {
            ...
            key: 'subjectEnum',
            render: (h,params)=>{
              return h('div',this.subjectList[params.row.subjectEnum].name)
            },
            align: 'center',
            width: 60
          },
    ...
    methods: {
      ...
      getList() {
        let params = {
          ...
          subjectEnum: this.searchInfo.subjectEnum,
