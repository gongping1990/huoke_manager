  ...
  export default {
    ...
    methods: {
      ...
      submitInfo() {
        ...
        switch (+this.type) {
          case 1:
            paramUrl = this.addInfo.id ? this.addInfo.operate == '1' ? this.$api.hkywhdMission.updateWord(this.addInfo) :
              this.$api.hkywhdMission.updateWordQuestion(this.addInfo) : this.$api.hkywhdMission.addWord(this.addInfo)
            break
          case 2:
            paramUrl = this.addInfo.id ? this.$api.hkywhdMission.updateRead(this.addInfo) : this.$api.hkywhdMission.addRead(this.addInfo)
            break
          case 3:
            paramUrl = this.addInfo.id ? this.$api.hkywhdMission.updateLecture(this.addInfo) : this.$api.hkywhdMission.addLecture(this.addInfo)
            break
        }
        paramUrl
          .then(res => {
