  ...
  export default {
    ...
    methods: {
      ...
      submitInfo() {
        ...
        switch (+this.type) {
          case 1:
            interParams = this.$api.hkywhdMission.wordPageNo
            break
          case 2:
            interParams = this.$api.hkywhdMission.readPageNo
            break
          case 3:
            interParams = this.$api.hkywhdMission.lecturePageNo
            break
        }
        interParams(param)
          .then(
      ...
      getList() {
        ...
        switch (+this.type) {
          case 1:
            params = this.$api.hkywhdMission.wordList
            break
          case 2:
            params = this.$api.hkywhdMission.readList
            break
          case 3:
            params = this.$api.hkywhdMission.lectureList
            break
        }
        params({
      ...
      delCheckpoint(data) {
        this.$Modal.confirm({
          ...
          onOk: () => {
            ...
            switch (+this.type) {
              case 1:
                params = this.$api.hkywhdMission.delWord
                break
              case 2:
                params = this.$api.hkywhdMission.delRead
                break
              case 3:
                params = this.$api.hkywhdMission.delLecture
                break
            }
            params({
              id: data.id
