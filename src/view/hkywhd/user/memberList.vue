  ...
  export default {
    ...
    methods: {
      ...
      getList(num) {
        ...
        this.$api.hkywhdUserMember.getUserMemberList(params)
          .then(
            response => {
      ...
      getDetailList(data) {
        this.$api.hkywhdUserMember.getUserInvitedList({
          current: 1,
          size: 1000,
          userId: data.userId
        })
      ...
      getDelay() {
        this.$api.hkywhdUserMember.getDelay()
          .then(
            response => {
      ...
      submitInfo() {
        this.$api.hkywhdUserMember.updateDelay({
