...
const tbzwLesson = {
  getLearnContent(params) {
    return axios.get("/compositionv2/lesson/getLearnContent", {
      params: params
    });
  },
  ...
  listCheckPoint(params) {
    return axios.get("/compositionv2/lesson/listCheckPoint", {
      params: params
    });
  },
  removeCheckPointById(params) {
    return axios.get("/compositionv2/lesson/removeCheckPointById", {
      params: params
    });
  },
  saveCheckPoint(params) {
    return axios.post(
      "/compositionv2/lesson/saveCheckPoint",
      qs.stringify(params)
    );
  },
  sortByIds(params) {
  ...
  listIllustrationBook(params) {
    return axios.get("/compositionv2/lesson/listIllustrationBook", {
      params: params
    });
  },
  removeIllustrationBookById(params) {
    return axios.get("/compositionv2/lesson/removeIllustrationBookById", {
      params: params
    });
  },
  saveIllustrationBook(params) {
    return axios.post(
      "/compositionv2/lesson/saveIllustrationBook",
      qs.stringify(params)
    );
  },
  saveCheckPointVideo(params) {
    return axios.post(
      "/compositionv2/lesson/saveCheckPointVideo",
      qs.stringify(params)
    );
  },
  listProblem(params) {
  ...
  removeProblemById(params) {
    return axios.get("/compositionv2/lesson/removeProblemById", {
      params: params
    });
  },
  ...
  saveLessonVideo(params) {
    return axios.post(
      "/compositionv2/lesson/saveLessonVideo",
      qs.stringify(params)
    );
  },
  saveStrokeImgById(params) {
    return axios.post(
      "/compositionv2/lesson/saveStrokeImgById",
      qs.stringify(params)
    );
  },
  saveCorrectTemplateById(params) {
    return axios.post(
      "/compositionv2/lesson/saveCorrectTemplateById",
      qs.stringify(params)
    );
  },
  listAudioTmpl(params) {
    return axios.get("/compositionv2/lesson/listAudioTmpl", { params });
  },
  removeAudioTmpl(params) {
    return axios.post(
      "/compositionv2/lesson/removeAudioTmpl",
      qs.stringify(params)
    );
  },
  editAudioTmpl(params) {
    return axios.post("/compositionv2/lesson/editAudioTmpl", params, {
